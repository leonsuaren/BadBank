...
export const AllData = () => {
  ...
  const fetchData = () => {
    axios.post('/api/account/find-costumer-accounts', { costumer: userEmail }).then((response) => {
  ...
  const handleOnAddAccount = async (e) => {
    e.preventDefault()
    await axios.post('/api/account/create-account', { accountType: 'Savings', accountNumber: accountNumber, accountName: accountName, balance: balance, costumer: userEmail }).then((response) => {
  ...
  const handleOnDeleteAccount = async (_id) => {
    await axios.post('/api/account/delete-bank-account', { _id: _id }).then((response) => {
      fetchData()
    }).catch((error) => {
    });
  }
